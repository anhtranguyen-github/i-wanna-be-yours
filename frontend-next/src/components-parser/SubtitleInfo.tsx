  ...
  return (
    <div className="w-full mt-1 mb-1">
      <button
        ...
        className="text-left text-sm font-bold flex items-center justify-between w-full p-1 bg-gray-100 text-neutral-ink rounded-md border border-gray-200 hover:bg-gray-200 transition-colors"
      >
