...
class StudyPlanService {
    ...
    async getJLPTInfo(): Promise<JLPTInfo> {
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/jlpt-info`);
    ...
    async listTemplates(level?: string): Promise<{ templates: PlanTemplateListItem[] }> {
        ...
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/templates${params}`);
    ...
    async getTemplate(templateId: string): Promise<PlanTemplateDetail> {
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/templates/${templateId}`);
    ...
    async createPlan(request: CreatePlanRequest): Promise<{ id: string; message: string; target_level: string; total_days: number }> {
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/plans`, {
            method: 'POST',
    ...
    async listPlans(userId: string, status?: string): Promise<{ plans: StudyPlanListItem[] }> {
        ...
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/plans?${params}`);
    ...
    async getPlan(planId: string): Promise<StudyPlanDetail> {
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/plans/${planId}`);
    ...
    async getMilestone(milestoneId: string): Promise<any> {
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/milestones/${milestoneId}`);
        return this.handleResponse(res);
    }
    ...
    async completeMilestone(milestoneId: string): Promise<{ message: string }> {
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/milestones/${milestoneId}/complete`, {
            method: 'PATCH',
        });
        return this.handleResponse(res);
    }
    ...
    async getDailyTasks(userId: string, date?: string): Promise<DailyTasksResponse> {
        ...
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/daily-tasks?${params}`);
    ...
    async completeTask(taskId: string, score?: number): Promise<{ message: string }> {
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/daily-tasks/${taskId}/complete`, {
            method: 'PATCH',
            headers: { 'Content-Type': 'application/json' },
    ...
    async getProgress(planId: string): Promise<PlanProgressReport> {
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/progress/${planId}`);
    ...
    async checkPlanHealth(planId: string): Promise<{
        ...
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/plans/${planId}/health`);
        return this.handleResponse(res);
    }
    ...
    async recalculatePlan(planId: string, newExamDate?: Date): Promise<{
        ...
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/plans/${planId}/recalculate`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    async updateFromQuiz(planId: string, quizResult: {
        ...
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/plans/${planId}/quiz-update`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    async updateFromSRS(userId: string, srsStats: {
        ...
        const res = await fetch(`${API_BASE_URL}/f-api/v1/study-plan/srs-update`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
