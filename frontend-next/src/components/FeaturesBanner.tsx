...
const FeaturesBanner: React.FC = () => {
  ...
  const pageUrl = 'https://hanachan.org'; // hanachan.org URL
  const pageTitle = 'hanachan.org - Free Open-Source Self-Hostable No-Ads Japanese Learning Platform';
  ...
  return (
    <div className="text-xs w-full">
      ...
      >
        ...
        <p>
          <span className="block sm:inline">List of all hanachan features</span>{" "}
          <a
            href="/"
            className="underline font-semibold hover:text-blue-600 transition-colors"
          >
      ...
      {/* New Alert Section for hanachan.org */}
      <div
      ...
      >
        <p>
          ...
          <span className="block sm:inline">
            hanachan.org is a free, open-source, self-hostable portal with no ads. We rely on the community to help spread the word. Sharing the link helps the project immensely!
          </span>
        </p>
        <p className="mt-1 mb-3">
          <span className="block sm:inline">Support the project by sharing the link to</span>{" "}
          <a
            href="https://hanachan.org"
