...
export function InformativeLoginCard({
    ...
    return (
        <motion.div
            ...
            className="w-full max-w-2xl mx-auto overflow-hidden rounded-[2.5rem] bg-neutral-white border border-neutral-gray/20 shadow-xl"
        >
            <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-5/12 bg-neutral-beige/50 p-8 flex flex-col items-center justify-center relative overflow-hidden">
                    ...
                    {previewImage ? (
                        <div className="relative z-10 w-full h-full min-h-[200px] rounded-2xl overflow-hidden shadow-inner border border-neutral-gray/10">
                        ...
                        <div className="relative z-10 w-32 h-32 rounded-3xl bg-neutral-white shadow-xl flex items-center justify-center">
                    ...
                    <div className="mt-8 text-center relative z-10">
                        <div className="text-[10px] font-black uppercase tracking-[0.2em] text-neutral-ink/30">
                ...
                <div className="md:w-7/12 p-10 flex flex-col">
                    ...
                    <p className="text-neutral-ink/60 font-medium mb-8 leading-relaxed">
                        {description}
                    </p>
                    ...
                    <div className="space-y-4 mb-10">
                        {benefits.map((benefit, i) => (
                            <div key={i} className="flex items-center gap-3">
                                ...
                                <span className="text-sm font-bold text-neutral-ink/80">{benefit}</span>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="mt-auto space-y-4">
                        <button
                            ...
                            className="w-full py-4 bg-neutral-ink text-white rounded-2xl font-black text-[11px] uppercase tracking-widest hover:bg-primary-strong transition-all shadow-lg shadow-neutral-ink/10 active:scale-[0.98] flex items-center justify-center gap-3"
                        >
                            <LogIn size={18} />
                            Initialize Account
                        </button>
                        <p className="text-center text-[9px] font-black text-neutral-ink/30 uppercase tracking-widest">
