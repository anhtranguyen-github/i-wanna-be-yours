...
const Sidebar = () => {
    ...
    return (
        <div className={`
            ...
            bg-white text-brand-dark border-2 border-slate-100 transition-all duration-300
            ${isChat
                ? 'rounded-l-3xl rounded-r-none border-r-0 pr-0'
                : 'rounded-3xl'
            }
        `}>
            {/* Logo area */}
            <div className="flex flex-col items-center gap-2 mb-8">
                <div className="w-12 h-12 bg-brand-salmon rounded-xl flex items-center justify-center text-2xl text-white">
                    🌸
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4 w-full px-2">
                {user ? (
                    <div className="flex flex-col items-center gap-2">
                        <div className="w-10 h-10 rounded-full bg-brand-sky border-2 border-brand-dark flex items-center justify-center font-bold text-brand-dark">
    ...
    return (
        <Link href={href} className="w-full relative group flex flex-col items-center">
            <div className={`
                ...
                ${active
                    ? 'bg-brand-salmon text-white scale-110 -rotate-3'
