            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="text-left space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-100 text-primary text-[10px] font-black uppercase tracking-[0.2em]  shadow-primary/5">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                            <Link
                                href="/study-plan"
                                className="w-full sm:w-auto px-10 py-5 bg-slate-900 text-white rounded-2xl font-black uppercase tracking-widest text-xs transition-all hover:scale-[1.02] active:scale-95  shadow-slate-900/20 flex items-center justify-center gap-3 group"
                            >
                                Initiate Strategy
                            ...
                            <Link
                                href="/tools"
                                className="w-full sm:w-auto px-10 py-5 bg-white border border-slate-100 text-neutral-ink rounded-2xl font-black uppercase tracking-widest text-xs transition-all hover:bg-slate-50  shadow-primary/5 flex items-center justify-center gap-3"
                            >
                    ...
                    <div className="relative animate-in fade-in slide-in-from-right-12 duration-1000 delay-300">
                        <div className="relative rounded-[3rem] overflow-hidden  shadow-primary/10 border border-white p-2 bg-white/50 backdrop-blur-sm">
                        ...
                        <div className="absolute -bottom-8 -right-8 bg-white p-4 rounded-2xl border border-slate-100  animate-pulse">
                            <div className="flex items-center gap-3">
