  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--background-default)' }}>
      <div className="container mx-auto py-8 px-4">
        <h1 className="text-4xl font-bold text-center mb-8" style={{ color: 'hsl(var(--primary))' }}>Kanji Radicals</h1>
        <p className="text-xs text-center mb-8" style={{ color: 'hsl(var(--text-default))' }}>
