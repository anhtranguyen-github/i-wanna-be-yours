...
export default function ExamSessionPage() {
    ...
    const handleSubmit = () => {
        ...
        // In a real app, we'd save results to backend here
    };

    // View results
    const handleViewResults = () => {
        router.push(`/practice/jlpt/result/${examId}`);
    };
    ...
    const isTimeLow = timeRemaining > 0 && timeRemaining <= 300; // 5 minutes warning
