...
export default function ExamResultPage() {
    ...
    // Mock results (in a real app, this would come from session storage or API)
    const mockResults = useMemo(() => {
        if (!questions.length) return null;

        // Simulate random answers for demo purposes
        const totalQuestions = questions.length;
        const correctAnswers = Math.floor(totalQuestions * 0.7); // 70% correct
        ...
        questions.forEach((q, idx) => {
            ...
            // Randomly assign correctness for demo
            if (idx % 3 !== 0) {
        ...
        return {
            ...
            timeTakenSeconds: 1847, // ~30 mins mock
            skillBreakdown,
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="text-center">
                    ...
                    <Link href="/practice/jlpt" className="text-brand-green hover:underline">
                        Back to Practice
                    </Link>
                </div>
            </div>
