...
const nextConfig = {
  async rewrites() {
    return [
      ...
      { source: '/d-api/v1/parse-tree', destination: `${process.env.HANACHAN_API_URL}/d-api/v1/parse-tree` },
      { source: '/d-api/v1/translate', destination: `${process.env.HANACHAN_API_URL}/d-api/v1/translate` },
